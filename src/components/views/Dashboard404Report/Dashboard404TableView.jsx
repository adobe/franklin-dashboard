...
import NoDataSkeleton from '../../core/Skeleton/NoDataSkeleton.jsx';

export function RumTableView({
  data, dataFlag: fetching, columns, columnHeadings,
}) {
  if (fetching) {
    return <ProgressBar margin="auto" label="Loading…" isIndeterminate />;
  }
