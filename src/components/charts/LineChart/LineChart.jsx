...
export function DashboardLineChart({
 ...
 <ResponsiveContainer  height="100%" width="100%">
      <LineChart
          ...
          data={data.slice(1)}
        >
          <XAxis type={'category'} dataKey={x_datakey} tickFormatter={(value, index) => {return new Date(value).toLocaleDateString('en-US')}} tick={{fontSize: '12px'}} angle={-45} reversed={true}/>
