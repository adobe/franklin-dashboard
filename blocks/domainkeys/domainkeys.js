...
export default function decorate(block) {
  ...
  inpDomain.name = 'url';
  inpDomain.readOnly = true;
  const lblNewKey = document.createElement('label');
  lblNewKey.setAttribute('for', 'newkey');
  lblNewKey.textContent = 'New Key';
  const inpNewKey = document.createElement('input');
  inpNewKey.id = 'newkey';
  inpNewKey.name = 'newkey';
  inpNewKey.placeholder = 'Leave blank or specify an existing key';
  const lblGrace = document.createElement('label');
  lblGrace.setAttribute('for', 'graceperiod');
  lblGrace.textContent = 'Grace Period';
  const inpGrace = document.createElement('input');
  inpGrace.id = 'graceperiod';
  inpGrace.name = 'graceperiod';
  inpGrace.placeholder = 'Leave blank or specify a grace period';
  const lblExpiry = document.createElement('label');
  lblExpiry.setAttribute('for', 'expiry');
  lblExpiry.textContent = 'Expiry';
  const inpExpiry = document.createElement('input');
  inpExpiry.id = 'expiry';
  inpExpiry.name = 'expiry';
  inpExpiry.type = 'date';
  ...
  */
  ...
  form.appendChild(inpDomainkey);
  form.appendChild(lblDomain);
  form.appendChild(inpDomain);
  form.appendChild(lblNewKey);
  form.appendChild(inpNewKey);
  form.appendChild(lblGrace);
  form.appendChild(inpGrace);
  form.appendChild(lblExpiry);
  form.appendChild(inpExpiry);
