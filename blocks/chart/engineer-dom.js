/**
 * select appropriate DOM operations and tie them to the type of chart, data being plotted;
 * some charts require different eventhandling and other DOM level operations that can be
 * specified below.
